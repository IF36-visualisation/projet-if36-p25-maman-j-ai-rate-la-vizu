...
-   Un graphique en barre réprésent
-   XXXX
...
Dans la continuité de la question précédente, nous nous demandons si on remarque
...
## 7. Peut-on afficher une corrélation entre l'usage principale et l'usage secondaire d'un batiement
