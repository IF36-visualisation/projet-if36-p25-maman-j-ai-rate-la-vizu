...
![Tableau de bords réalisé sur Tableau](images/7_Usages principal et secondaire.png)
...
Variables utilisées: NB_LOGTS (nombre de logements par bâtiment), USAGE1 et USAGE2 Moyenne nationale selon FNAIM: 55% de maison, 45% d'appartement Moyenne dans l'Aube selon FNAIM: entre 20% et 40% d'appartement Qu'en est-il de Troyes?
