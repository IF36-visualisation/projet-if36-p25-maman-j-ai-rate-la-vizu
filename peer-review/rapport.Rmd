...
## Questions répartitions simples
...
plot_périodes = function(df, period_list) {
    ...
    ggplot(df) +
    geom_sf(data = osm_roads$osm_lines, color = "grey80", size = 0.15, inherit.aes = FALSE) +
    geom_sf(data = osm_water$osm_lines, color = "skyblue", size = 0.2, inherit.aes = FALSE) +
